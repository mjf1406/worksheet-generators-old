...
tippy('#sections-help', {
    content: "Splits the word search into equal sized sections which are then made visible."
})
...
download.addEventListener('click', function(){
    ...
    let worksheet = document.getElementById('word-search-worksheet')
...
function updateWordSearchPreview(wordSearchData){
    let preview = document.getElementById('preview-word-search')
    preview.innerHTML = ''
